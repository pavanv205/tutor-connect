...
//#region \0cjs-shim:backend_cors
var require__cjs_shim_backend_cors = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	module.exports = requireFromContext("cors");
}));
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require__cjs_shim_backend_cors();
  }
});