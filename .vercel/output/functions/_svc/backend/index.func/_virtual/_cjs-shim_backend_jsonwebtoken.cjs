...
//#region \0cjs-shim:backend_jsonwebtoken
var require__cjs_shim_backend_jsonwebtoken = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	module.exports = requireFromContext("jsonwebtoken");
}));
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require__cjs_shim_backend_jsonwebtoken();
  }
});