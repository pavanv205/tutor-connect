...
//#region \0cjs-shim:backend_mongoose
var require__cjs_shim_backend_mongoose = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	module.exports = requireFromContext("mongoose");
}));
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require__cjs_shim_backend_mongoose();
  }
});