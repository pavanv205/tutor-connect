...
//#region \0cjs-shim:backend_multer
var require__cjs_shim_backend_multer = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	module.exports = requireFromContext("multer");
}));
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require__cjs_shim_backend_multer();
  }
});