...
//#region \0cjs-shim:backend_bcryptjs
var require__cjs_shim_backend_bcryptjs = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	module.exports = requireFromContext("bcryptjs");
}));
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require__cjs_shim_backend_bcryptjs();
  }
});